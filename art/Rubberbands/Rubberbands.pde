int[] pointxs = new int[100];
int[] pointys = new int[100];
int[] pointreds = new int[100];
int[] pointgreens = new int[100];
int[] pointblues = new int[100];
float eqlength = 200;
float springconstant = 0.016;
float g = 10.3;
float ballmass = 10;
float b = 0.005;
float ballx = 600;
...
void init() {
  for (int i = 0; i < 100; i++) {
    ...
    pointys[i] = 400 + floor(random(200, 300)*sin(theta));
...
void drawelements() {
  for (int i = 0; i < 100; i++) {
    ...
    float coloroffset = len/2/eqlength;
